                ...
                <footer>
                    <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
                        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                            <div>
                                <div className="text-teal-600 flex justify-start items-center ">
                                    <Image
                                        src="/AJLogo.png"
                                        height={50}
                                        width={50}
                                    ...
                                    />
                                    <p className='ml-4'>AJ OnlineMarket</p>

                                </div>

                                <p className="mt-4 max-w-xs text-gray-500">
                                    Explore the latest models from top brands like Samsung, Apple, and Google. From sleek designs to powerful performance, AJ has your communication needs covered.
                                </p>
                            ...
                            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
                                <div>
                                    ...
                                    <ul className="mt-6 space-y-4 text-sm">
                                        ...
                                        <li>
                                            <a href="#" className="text-gray-700 transition hover:opacity-75"> Become a Host </a>
                                        </li>
                                        ...
                                        <li>
                                            <a href="#" className="text-gray-700 transition hover:opacity-75"> Lowest Rate </a>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div>
                                    ...
                                    <ul className="mt-6 space-y-4 text-sm">
                                        <li>
                                            <Link href="/contact-us" className="text-gray-700 transition hover:opacity-75"> Contact </Link>
                                        </li>
                        ...
                        <section>
                            <footer className="bg-green-200 text-white py-4 px-3">
                                <div className="container mx-auto flex flex-wrap items-center justify-between">
                                    <div className="w-full md:w-1/2 md:text-center md:mb-4 mb-8">
                                        <p className="text-xs text-muted-foreground md:text-sm">AJ OnlineMarket Copyright 2024 &copy; All Rights Reserved</p>
                                    </div>
